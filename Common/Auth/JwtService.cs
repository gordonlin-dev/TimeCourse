...
namespace Common.Auth
{
    public interface IJwtService
    {
        ...
        public ClaimsPrincipal GenerateClaimsPrincipalFromUser(Model.User user);
    }
    public class JwtService : IJwtService
    {
        private readonly IOptions<Settings.JWT> _jwtSettings;
        public JwtService(IOptions<Settings.JWT> settings)
        {
